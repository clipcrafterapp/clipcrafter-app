  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white">
      <section className="flex flex-col items-center justify-center py-32 px-4 text-center">
        <h1 className="text-6xl font-bold tracking-tight mb-4">ClipCrafter</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a
            href="/sign-up"
            className="rounded-lg bg-violet-600 px-8 py-3 font-semibold hover:bg-violet-500 transition-colors"
          >
            Get Started
          </a>
          <a
            href="/sign-in"
            className="rounded-lg border border-gray-700 px-8 py-3 font-semibold hover:border-gray-500 transition-colors"
          >
            Sign In
          </a>
        </div>
